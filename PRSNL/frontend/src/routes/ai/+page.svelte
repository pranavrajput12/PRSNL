        ...
        <section class="categories-section">
          ...
          {#if categoryStats.length === 0}
            <div class="empty-state">
              ...
              <p class="help-text">Add content to your knowledge base to see AI-generated categories</p>
            </div>
          {:else}
              ...
              {#each categoryStats as stat}
                <div class="category-bar">
                  ...
                  <div class="bar-container">
                    <div 
                      class="bar" 
                      style="width: {Math.min(100, (stat.count / Math.max(...categoryStats.map(s => s.count)) * 100))}%; 
                             background-color: {stat.confidence > 0.7 ? 'var(--ai-success)' : 
                                              stat.confidence > 0.4 ? 'var(--ai-warning)' : 
                                              'var(--ai-error)'};"
                    ></div>
                  </div>
        ...
        <section class="duplicates-section">
          <div class="section-header">
            ...
            <p>
              ...
              ({getTotalItemsWithDuplicates()} items affected)
            </p>
          </div>
            ...
            <div class="topic-clusters">
              {#each topicClusters as cluster}
                <div class="topic-card">
                  ...
                  <a href={`/search?q=${encodeURIComponent(cluster.topic)}&mode=semantic`} class="view-link">
