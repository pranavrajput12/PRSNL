						...
						<div class="insight-card">
							<div class="insight-header">
								...
								<div class="insight-meta">
									<span class="severity {getSeverityColor(insight.severity)}">{insight.severity || 'medium'}</span>
									<span class="confidence">{Math.round((insight.confidence_score || 0) * 100)}% confidence</span>
								</div>
							</div>
