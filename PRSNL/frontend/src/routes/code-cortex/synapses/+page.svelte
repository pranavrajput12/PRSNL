  ...
  const sampleSynapses: Synapse[] = [
    {
      ...
      type: 'learning_path',
      content:
        "Based on your JavaScript knowledge and interest in frontend development, here's a structured path to master React with TypeScript.",
      source_items: [
    ...
    },
    {
      ...
      type: 'connection',
      content:
        'Your REST API documentation connects with GraphQL concepts. Consider exploring GraphQL for more flexible data fetching.',
      source_items: [
...
<div class="synapses-page">
  ...
  <div class="coming-soon-banner">
    ...
    <div class="banner-content">
      ...
      <p>
        We're developing an intelligent system that will analyze your development content and
        generate meaningful connections, learning paths, and insights. This feature will help you
        discover relationships between your documentation, identify knowledge gaps, and suggest
  ...
  <div class="preview-section">
    <h2>🔮 Preview: What AI Synapses Will Do</h2>
    ...
    <div class="features-grid">
      <div class="feature-card">
        ...
        <p>
          Automatically discover relationships between your documentation, code snippets, and
          learning resources.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p>
          Generate personalized learning sequences based on your current knowledge and career goals.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p>
          Identify patterns in your learning, spot knowledge gaps, and suggest areas for
          improvement.
        </p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p>
          Get AI-powered suggestions for relevant documentation, tools, and resources based on your
          projects.
        </p>
      </div>
    </div>
  ...
  <div class="demo-section">
    <h2>📋 Sample Synapses (Demo)</h2>
    <p class="demo-note">
      Here's what AI-generated synapses might look like once the feature is ready:
    </p>
        ...
        <article class="synapse-card" style="border-left-color: {getSynapseColor(synapse.type)}">
          <div class="synapse-header">
            <div class="synapse-meta">
              <span
                class="synapse-type"
                style="background: {getSynapseColor(synapse.type)}20; color: {getSynapseColor(
                  synapse.type
                )}"
              >
                {getSynapseIcon(synapse.type)}
                {synapse.type.replace('_', ' ')}
              </span>
  ...
  <div class="cta-section">
    <div class="cta-content">
      <h3>🚀 Help Shape This Feature</h3>
      <p>
        We're designing AI Synapses to be as useful as possible for developers. Your input will help
