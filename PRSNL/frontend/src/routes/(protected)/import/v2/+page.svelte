...
<div class="container">
  ...
  <div class="import-options">
    ...
    >
      <div class="trace-pattern">
        ...
        <div class="trace-line vertical"></div>
        <div class="via"></div>
        <div class="via bottom-right"></div>
      </div>
  ...
  >
    <div class="circuit-traces">
      <div class="main-trace top-left"></div>
      <div class="main-trace top-right"></div>
      <div class="main-trace bottom-left"></div>
      <div class="main-trace bottom-right"></div>
      <div class="connection-via top-left"></div>
      <div class="connection-via top-right"></div>
      <div class="connection-via bottom-left"></div>
