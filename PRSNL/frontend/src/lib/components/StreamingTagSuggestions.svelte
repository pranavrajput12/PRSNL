...
<div class="tag-suggestions">
  <div class="header">
    ...
    {#if !autoSuggest}
      <button class="refresh-btn" on:click={refresh} disabled={isLoading}>
  ...
  {#if isLoading && suggestions.length === 0}
    <div class="loading" transition:fade={{ duration: 200 }}>
      <div class="pulse-container">
        {#each Array(3) as _, i}
          <div class="pulse-tag" style="animation-delay: {i * 0.1}s"></div>
        {/each}
      </div>
        ...
        >
          ...
          <div class="confidence-indicator">
            <div
              ...
              style="width: {suggestion.confidence * 100}%; background-color: {getConfidenceColor(
