...
<div class="github-repo-card" class:compact>
  ...
  <div class="repo-header">
    <div class="owner-info">
      ...
      <div class="repo-names">
        <a href="https://github.com/{owner.login}" target="_blank" rel="noopener noreferrer" class="owner-name">
          {owner.login}
        </a>
        <h3 class="repo-name">
    ...
    <a href={repoData.url} target="_blank" rel="noopener noreferrer" class="github-link" title="View on GitHub">
  ...
  <div class="repo-footer">
    ...
    <div class="repo-actions">
      {#if repo.homepage}
        <a href={repo.homepage} target="_blank" rel="noopener noreferrer" class="action-link" title="Visit homepage">
          <Icon name="globe" size="small" />
        </a>
      {/if}
      <a href="{repoData.url}/issues" target="_blank" rel="noopener noreferrer" class="action-link" title="View issues">
        <Icon name="message-circle" size="small" />
      </a>
      <button class="action-link" title="Copy clone URL" on:click={() => navigator.clipboard.writeText(repo.clone_url)}>
