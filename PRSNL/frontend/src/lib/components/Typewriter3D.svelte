...
<style>
  ...
  @keyframes paper-vibrate {
    0%, 100% { transform: rotateX(15deg) translateY(-2px) translateX(0); }
    50% { transform: rotateX(15deg) translateY(-2px) translateX(0.5px); }
  }
  ...
  @keyframes key-gentle-press {
    0%, 95%, 100% { transform: translateZ(0); }
    97% { transform: translateZ(-0.5px); }
  }
  ...
  @keyframes type-strike {
    ...
    50% { transform: translateY(-1px) rotateX(-15deg); }
  ...
  .message-bubble:nth-child(1) { top: 10%; left: 20%; animation-delay: 0s; }
  .message-bubble:nth-child(2) { top: 30%; right: 15%; animation-delay: 0.5s; }
  .message-bubble:nth-child(3) { top: 50%; left: 10%; animation-delay: 1s; }
  .message-bubble:nth-child(4) { top: 70%; right: 20%; animation-delay: 1.5s; }
  .message-bubble:nth-child(5) { top: 20%; left: 60%; animation-delay: 2s; }
  .message-bubble:nth-child(6) { top: 80%; left: 40%; animation-delay: 2.5s; }
  ...
  .particle:nth-child(6) { top: 10%; left: 50%; }
  .particle:nth-child(7) { top: 80%; left: 40%; }
  .particle:nth-child(8) { top: 50%; left: 80%; }
  ...
  .typewriter-container.hovered .typewriter-body {
    animation: vintage-sway 3s ease-in-out infinite, hover-glow 2s ease-in-out infinite;
  }
