      ...
      slides: [
        {
          ...
          description: "General mode provides balanced, comprehensive responses that consider multiple perspectives.",
          features: [
      ...
      slides: [
        {
          ...
          description: "Research mode helps you thoroughly analyze topics, find patterns, and discover connections across your knowledge base.",
          features: [
          ...
          examples: [
            {
              ...
              description: "Get comprehensive analysis with patterns, gaps, and connections to other topics"
            },
            {
              query: "Find connections between my business and tech notes",
              description: "Discover how different topics in your knowledge base relate to each other"
            },
            {
      ...
      slides: [
        {
          ...
          description: "Learning mode helps you understand and retain information more effectively through educational techniques.",
          features: [
      ...
      slides: [
        {
          ...
          description: "Creative mode generates novel ideas and unexpected connections between concepts in your knowledge base.",
          features: [
