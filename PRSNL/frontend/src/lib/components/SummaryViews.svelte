  ...
  <div class="tabs-container">
    ...
    <div class="tab-content">
      ...
      {:else if error}
        <div class="error">
          <p>{error}</p>
          <button class="btn btn-secondary" on:click={() => generateSummary(activeTab)}>Try Again</button>
        </div>
      ...
      {:else}
        <div class="empty-state">
          ...
          <button class="btn btn-primary" on:click={() => generateSummary(activeTab)}>Generate</button>
        </div>
      {/if}
    </div>
  </div>
