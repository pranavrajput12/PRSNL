  ...
  let analysisProgress = $derived(
    activeAnalysis
      ? {
          ...
          processingStartTime: activeAnalysis.created_at
            ? new Date(activeAnalysis.created_at).getTime()
            : Date.now(),
        }
      : null
  );
          ...
          {#if analysis.job_status === 'completed'}
            <div class="analysis-scores">
              <div class="score-item">
                ...
                <span class="score-value" style="color: {getScoreColor(analysis.security_score)}">
              ...
              <div class="score-item">
                ...
                >
                  {analysis.performance_score
                    ? `${Math.round(analysis.performance_score)}%`
                    : 'N/A'}
                </span>
              </div>
              ...
              <div class="score-item">
                ...
                <span class="score-value" style="color: {getScoreColor(analysis.quality_score)}">
            ...
            <div class="analysis-actions">
              <a href="/code-cortex/codemirror/insights/{analysis.id}" class="action-link">
                View Insights →
              </a>
