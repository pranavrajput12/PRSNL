    ...
    <div class="scores-section">
      ...
      <div class="scores-grid">
        ...
        <div class="score-card {getScoreBackground(stats.averageSecurityScore)}">
          ...
          <div class="score-bar">
            <div class="score-bar-fill security" style="width: {stats.averageSecurityScore}%"></div>
          </div>
        </div>
        ...
        <div class="score-card {getScoreBackground(stats.averageQualityScore)}">
          ...
          <div class="score-bar">
            <div class="score-bar-fill quality" style="width: {stats.averageQualityScore}%"></div>
          </div>
        </div>
      </div>
    </div>
