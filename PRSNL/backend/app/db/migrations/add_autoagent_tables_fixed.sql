-- AutoAgent Integration Tables for PRSNL Second Brain (Fixed for UUID)
-- ===================================================
...
CREATE TABLE IF NOT EXISTS agent_insights (
    ...
    related_items UUID[] DEFAULT ARRAY[]::UUID[],
...
CREATE TABLE IF NOT EXISTS content_explorations (
    id SERIAL PRIMARY KEY,
    user_id VARCHAR(255),
    starting_item_id UUID REFERENCES items(id),
    exploration_path JSONB NOT NULL,
    discoveries UUID[] DEFAULT ARRAY[]::UUID[],
