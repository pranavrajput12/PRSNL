...
CREATE TABLE codemirror_analyses (
    ...
    INDEX idx_codemirror_analyses_repo (repo_id),
    INDEX idx_codemirror_analyses_type (analysis_type),
    INDEX idx_codemirror_analyses_created (created_at DESC)
);
...
CREATE TABLE codemirror_patterns (
    ...
    INDEX idx_codemirror_patterns_user (user_id),
    INDEX idx_codemirror_patterns_signature (pattern_signature),
    INDEX idx_codemirror_patterns_type (pattern_type),
    INDEX idx_codemirror_patterns_occurrences (occurrence_count DESC)
);
...
CREATE TABLE codemirror_repo_mappings (
    ...
    INDEX idx_codemirror_mappings_user (user_id)
);
...
CREATE TABLE codemirror_insights (
    ...
    INDEX idx_codemirror_insights_analysis (analysis_id),
    INDEX idx_codemirror_insights_status (status),
    INDEX idx_codemirror_insights_type (insight_type)
);
...
CREATE TABLE codemirror_cli_sync (
    ...
    INDEX idx_codemirror_sync_user (user_id),
    INDEX idx_codemirror_sync_token (sync_token)
);
