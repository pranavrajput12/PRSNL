...
class CodeRepositoryAnalysisAgent:
    ...
    async def analyze_repository(
        ...
        try:
            ...
            response = await unified_ai_service.complete(
                ...
                Analyze the provided code repository and provide actionable insights on:
                ...
                Return your analysis in JSON format with scores (0-100) and specific recommendations.""",
    ...
    def _parse_analysis_response(self, response: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "security_score": 75,  # Default scores
            "performance_score": 75,
            "quality_score": 75,
            "summary": "Analysis completed - see raw_analysis for details",
            "recommendations": [
...
class CodePatternDetectionAgent:
    ...
    def _parse_pattern_response(self, response: str) -> List[Dict[str, Any]]:
        ...
        return [{
            ...
            "pattern_signature": "General code analysis",
