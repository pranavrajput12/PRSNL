-- Knowledge Graph Extension for Cross-Feature Integration
...
CREATE INDEX IF NOT EXISTS idx_code_entities_file ON code_entities(repository_id, file_path, entity_type);
