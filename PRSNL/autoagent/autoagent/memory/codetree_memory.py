...
if __name__ == "__main__":
    ...
    code_memory = CodeTreeMemory(project_path = './code_db', db_name='code_tree', platform='OpenAI', api_key=api_key)
    
    # 添加代码文件到内存
    code_memory.add_code_files("/path/to/your/project", exclude_prefix=['workplace_', '__pycache__', 'code_db', '.git'])
